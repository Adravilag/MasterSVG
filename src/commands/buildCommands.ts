        ...
        async progress => {
          ...
          for (const [filePath, refs] of Array.from(refsByFile.entries())) {
            ...
            try {
              ...
              console.error('[MasterSVG] Error transforming references in', filePath, err);
              failed++;
            }
          }
        ...
        async progress => {
          ...
          for (const icon of allSvgFiles) {
            ...
            try {
              ...
              console.error('[MasterSVG] Error building', icon.name, err);
              failed++;
            }
          }
            ...
            for (const icon of allSvgFiles) {
              if (icon.path) {
                try {
                  ...
                  console.error('[MasterSVG] Error deleting', icon.path, err);
                }
              }
            }
            vscode.window.showInformationMessage(
