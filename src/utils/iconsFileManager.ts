 ...
 */
export async function generateWebComponent(outputPath: string): Promise<void> {
...
class IconElement extends HTMLElement {
  ...
  render() {
    ...
    // Use specified animation, or fall back to default animation for this icon
...
export function removeFromIconsJs(outputPath: string, iconNames: string[]): boolean {
  ...
  for (const name of iconNames) {
    ...
    const iconsObjRegex = new RegExp(`,?\\s*${varName}\\s*,?`, 'g');
