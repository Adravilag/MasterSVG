...
function getBasicLabels(): Record<string, string> {
  return {
    ...
    bgTransparentLabel: t('welcome.bgTransparentLabel'),
    bgLightLabel: t('welcome.bgLightLabel'),
    bgDarkLabel: t('welcome.bgDarkLabel'),
    bgCheckeredLabel: t('welcome.bgCheckeredLabel'),
    defaultSvgColorLabel: t('welcome.defaultSvgColorLabel'),
    defaultSvgColorHint: t('welcome.defaultSvgColorHint'),
    defaultSvgColorBadge: t('welcome.defaultSvgColorBadge'),
    cssElementTagLabel: t('welcome.cssElementTagLabel'),
    cssElementTagHint: t('welcome.cssElementTagHint'),
    ...
    groupGeneral: t('welcome.groupGeneral'),
    groupPresentation: t('welcome.groupPresentation'),
    groupAppearance: t('welcome.groupAppearance'),
