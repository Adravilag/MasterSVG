...
import {
  OptimizeResult as CentralizedOptimizeResult,
  OptimizeOptions as CentralizedOptimizeOptions,
} from '../types/mastersvgTypes';

// Re-export centralized types for backwards compatibility
export type OptimizeResult = CentralizedOptimizeResult;
export type OptimizeOptions = CentralizedOptimizeOptions
