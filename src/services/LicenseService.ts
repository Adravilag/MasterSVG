...
/**
 * Ensure collections are loaded into cache
 * Call this before using getIconLicenseInfoSync to ensure cache is populated
 */
export async function ensureCollectionsLoaded(): Promise<void> {
  if (!collectionsCache) {
    try {
      await fetchCollections();
    } catch {
      // Silently fail - getIconLicenseInfoSync will return null
    }
  }
}
...
function generateCollectionLicense(
  ...
  content += `\n---\n`;
  content += `*This file was auto-generated by MasterSVG Icon Studio*\n`;
...
export function generateCombinedLicense(
  ...
  content += `\n*This file was auto-generated by MasterSVG Icon Studio on ${new Date().toISOString().split('T')[0]}*\n`;
