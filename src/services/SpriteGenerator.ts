...
export class SpriteGenerator {
   ...
   */
  private createSymbol(icon: SpriteIcon, options: SpriteOptions): { id: string; symbol: string; size: number } {
   ...
   */
  private wrapInSprite(symbols: string[], options: SpriteOptions): string {
