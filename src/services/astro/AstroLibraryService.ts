...
import {
  AstroLibraryConfig as CentralizedAstroLibraryConfig,
  IconSelectionResult as CentralizedIconSelectionResult,
} from '../types/mastersvgTypes';

// Re-export for backwards compatibility
export type AstroLibraryConfig = CentralizedAstroLibraryConfig;
export type IconSelectionResult = CentralizedIconSelectionResult;
