...
import type { IconAnimationAssignment, AnimationsDataFile } from '../types';

// Re-export for backwards compatibility
export type IconAnimation = IconAnimationAssignment;
export type AnimationsData = AnimationsDataFile;
