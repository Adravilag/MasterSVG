...
import type { SimpleAnimationSettings, DetectedAnimationInfo } from '../types';

// Re-export for backwards compatibility
export type AnimationSettings = SimpleAnimationSettings;
export type DetectedAnimation = DetectedAnimationInfo;
