...
describe('IconStudioPanel', () => {
  ...
  beforeEach(() => {
    // Reset singleton
    (IconStudioPanel as any).currentPanel = undefined;
  ...
  describe('RF-8.1: Panel principal', () => {
    ...
    test('CA-8.1.3: createOrShow con searchQuery debe enviar mensaje de búsqueda', () => {
      ...
      IconStudioPanel.createOrShow(extensionUri, mockContext as vscode.ExtensionContext, 'arrow');
  ...
  describe('RF-8.2: Comunicación webview', () => {
    ...
    test('CA-8.2.2: postMessage debe enviar mensaje al webview', () => {
      ...
      const currentPanel = (IconStudioPanel as any).currentPanel;
    ...
    test('CA-8.2.4: dispose debe limpiar currentPanel', () => {
      ...
      expect((IconStudioPanel as any).currentPanel).toBeDefined();

      // Simular dispose
      const currentPanel = (IconStudioPanel as any).currentPanel;
      currentPanel.dispose();

      expect((IconStudioPanel as any).currentPanel).toBeUndefined();
    });
  });
